...
async def run():
    ...
    checkpoints = [
                ("Checkpoint 1", VelocityNedYaw(-0.2, 0.6, 0.0, 0.0), 10),
                ("Checkpoint 2", VelocityNedYaw(-0.2, -0.1, 0.0, 0.0), 10),
                ("Checkpoint 3", VelocityNedYaw(-0.09, -0.69, 0.0, 0.0), 10),
                ("Home", VelocityNedYaw(0.54, 0.19, 0.0, 0.0), 10),
    ]
