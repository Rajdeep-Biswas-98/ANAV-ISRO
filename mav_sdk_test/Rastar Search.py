...
async def run():
    ...
    checkpoints = [
                ...
                ("Checkpoint", VelocityNedYaw(0.3038, 0.0, 0.0, 0.0), 8),
                ("Checkpoint", VelocityNedYaw(0.0, 0.1854, 0.0, 0.0), 7),
                ("Land", VelocityNedYaw(0.0, -0.09, 0.0, 0.0), 5),
                ("Checkpoint", VelocityNedYaw(0.0, 0.3105, 0.0, 0.0), 10),
                ("Checkpoint", VelocityNedYaw(-0.045, 0.0, 0.0, 0.0), 5),
                ("Land", VelocityNedYaw(0.0, -0.081, 0.0, 0.0), 5),
                ("Checkpoint", VelocityNedYaw(-0.2205, 0.0, 0.0, 0.0), 10),
                ("Checkpoint", VelocityNedYaw(0.0, -0.0826, 0.0, 0.0), 5),
                ("Land", VelocityNedYaw(0.0794, 0.0, 0.0, 0.0), 5),
                ("Checkpoint", VelocityNedYaw(-0.0794, 0.0, 0.0, 0.0), 5),
                ("Land", VelocityNedYaw(0.0, -0.3105, 0.0, 0.0), 10),
    ]
